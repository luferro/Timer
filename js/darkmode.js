...
reset_button.addEventListener('click', e => {
    ...
    localStorage.setItem("color_primary_dark", "rgb(255, 255, 255, 1)");
    ...
    localStorage.setItem("color_primary_light", "rgba(238,174,202,1)");
    body.style.setProperty('--light-secondary-color', "rgba(148,233,225,1)"); 
    localStorage.setItem("color_secondary_light", "rgba(148,233,225,1)");
})
